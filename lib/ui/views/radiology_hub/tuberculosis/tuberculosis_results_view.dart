...
class TuberculosisResultsView extends StatelessWidget {
  const TuberculosisResultsView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final vm = context.watch<TuberculosisViewModel>();
    return BaseViewWidget(
      ...
      body: Column(
        children: <Widget>[
          ...
          Text(
            // ignore: unnecessary_null_comparison
            'Normal / No TB: ${vm.modelResults?.normal?.toStringAsFixed(3)}',
            textAlign: TextAlign.center,
          ...
          Text(
            // ignore: unnecessary_null_comparison
            'Tuberculosis: ${vm.modelResults?.tuberculosis?.toStringAsFixed(3)}',
            textAlign: TextAlign.center,
