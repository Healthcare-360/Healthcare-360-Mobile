...
abstract class OcularClassifier {
  ...
  final String _ocularLabelFile = AppLabels.ocular;

  final int _ocularLabelsLength = 7;
  ...
  OcularClassifier({int? numThreads}) {
  ...
  Future<void> loadLabels() async {
    labels = await FileUtil.loadLabels(_ocularLabelFile);
    if (labels.length == _ocularLabelsLength) {
