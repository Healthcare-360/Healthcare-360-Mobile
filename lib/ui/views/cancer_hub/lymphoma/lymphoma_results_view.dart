...
class LymphomaResultsView extends StatelessWidget {
  const LymphomaResultsView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final vm = context.watch<LymphomaViewModel>();
    return BaseViewWidget(
      ...
      body: Column(
        children: <Widget>[
          ...
          Text(
            // ignore: unnecessary_null_comparison
            'CLL (Chronic Lymphocytic Leukemia): ${vm.modelResults?.cll?.toStringAsFixed(3)}',
            textAlign: TextAlign.center,
          ...
          Text(
            // ignore: unnecessary_null_comparison
            'FL (Follicular Lymphoma): ${vm.modelResults?.fl?.toStringAsFixed(3)}',
            textAlign: TextAlign.center,
          ...
          Text(
            // ignore: unnecessary_null_comparison
            'MCL (Mantle Cell Lymphoma): ${vm.modelResults?.mcl?.toStringAsFixed(3)}',
            textAlign: TextAlign.center,
