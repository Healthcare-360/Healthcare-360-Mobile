...
class MalariaResultsView extends StatelessWidget {
  const MalariaResultsView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final vm = context.watch<MalariaViewModel>();
    return BaseViewWidget(
      ...
      body: Column(
        children: <Widget>[
          ...
          Text(
            // ignore: unnecessary_null_comparison
            'Uninfected / No Malaria: ${vm.modelResults?.uninfected?.toStringAsFixed(3)}',
            textAlign: TextAlign.center,
          ...
          Text(
            // ignore: unnecessary_null_comparison
            'Parasitized / Malaria: ${vm.modelResults?.parasitized?.toStringAsFixed(3)}',
            textAlign: TextAlign.center,
