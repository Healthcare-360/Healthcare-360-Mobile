...
import 'package:healthcare_360_mobile/core/models/retinal_models/retinopathy_model.dart';
...
import 'package:healthcare_360_mobile/ui/views/retinal_hub/retinopathy/retinopathy_results_view.dart';
import 'package:image_picker/image_picker.dart';
import 'package:image/image.dart' as img;
import 'package:tflite_flutter_helper/tflite_flutter_helper.dart';
import 'package:get/get.dart';

class RetinopathyViewModel with notify.ChangeNotifier {
  bool _loading = false;
  ...
  void _predict() async {
    ...
    setState(false);
    Get.to(() => const RetinopathyResultsView(),
        transition: Transition.noTransition);
  }
}
