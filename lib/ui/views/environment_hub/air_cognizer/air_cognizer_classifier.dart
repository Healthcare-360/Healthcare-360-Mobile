...
abstract class AirCognizerClassifier {
  ...
  final String _modelLabelsFile = AppLabels.cognizer;

  final int _modelLabelsLength = 22;
  ...
  AirCognizerClassifier({int? numThreads}) {
