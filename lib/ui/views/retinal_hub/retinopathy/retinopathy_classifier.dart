...
abstract class RetinopathyClassifer {
  ...
  final String _retinopathyLabelsFile = AppLabels.retinopathy;

  final int _retinopathyLabelsLength = 5;
  ...
  RetinopathyClassifer({int? numThreads}) {
  ...
  Future<void> loadLabels() async {
    labels = await FileUtil.loadLabels(_retinopathyLabelsFile);
    if (labels.length == _retinopathyLabelsLength) {
