...
class LymphomaViewModel with notify.ChangeNotifier {
  bool _loading = false;
  ...
  LymphomaClassifier _classifier = LymphomaClassifierFloat();
  LymphomaClassifier get classifier => _classifier;

  Category? _category;
  Category? get category => _category;

  LymphomaModel? _modelResults;
  LymphomaModel? get modelResults => _modelResults;
  ...
  _reshapeResults() {
    _modelResults = LymphomaModel.fromJson(json: _results!.results);
  }
  ...
  void _predict() async {
    ...
    setState(false);
    Get.to(() => const LymphomaResultsView(),
